...
namespace util {
    ...
    /**
     * @brief getFirstDevice returns the first device that can be used with OpenCL, will exit if
     * none ist found
     ...
     * @param path Path to the shader code, without file extensions, function will automatically
     * look for `path + .vert` and `path + .frag`
